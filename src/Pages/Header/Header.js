...
const Header = () => {
	...
	return (
	  <div class="bg-gray-900 font-poppins">
		<div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
		  <div class="relative flex items-center justify-between">
			...
			>
			  ...
			  <span class="ml-2 font-poppins text-xl font-bold tracking-wide text-green-700 uppercase">
				MR. Tour Guider
			  </span>
			</Link>
			...
			<ul class="flex items-center hidden space-x-8 lg:flex">
			  <li>
				<Link
				  to=""
				  class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-green-700 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
				  aria-label="Sign up"
				  title="Sign up"
				>
				  Log Out
